	...
	<?php foreach ($data[$id] as $eid => $page):?>
		...
		<div class="item-wrapper">
			<div class="item-inner">
				...
				<span class="page-handle<?php if($permissions['reorder'] == 'none') echo " page-handle-disabled";?>
				<?php if (isset($permissions['reorder']) && ($permissions['reorder'] == 'all' || (is_numeric($level_lock_reorder)) && ($page['depth'] + 1) > $level_lock_reorder)) echo " drag-handle"?>"><a href="#">Move</a></span>
