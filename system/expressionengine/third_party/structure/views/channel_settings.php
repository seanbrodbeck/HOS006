...
<div class="padder">
	...
	<div class="ootb-message-go">
		<p><?=lang('ootb_message_channel_settings_go')?>! <span class="ootb-message-btn" id="tree-controls"><a href="#" class="pop tree-add-solo" title="pop"><?=lang('ootb_add_first_page')?></a></span></p>
	</div> <!-- close .ootb-message -->
	<?php endif; ?>
