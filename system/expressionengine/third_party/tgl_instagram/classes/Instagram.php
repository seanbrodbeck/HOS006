...
class Instagram {
    ...
    protected $_endpointUrls = array(
        ...
        'user_recent' => 'https://api.instagram.com/v1/users/%s/media/recent/?access_token=%s&max_id=%s&min_id=%s&max_timestamp=%s&min_timestamp=%s&count=32',
    ...
    */
    ...
    protected function _setOauthToken() {
        ...
        $this->_httpClient->setPostParam('redirect_uri', urldecode($this->_config['redirect_uri']));
