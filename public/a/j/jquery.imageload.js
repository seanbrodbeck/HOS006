        ...
        */
        init: function(type, element, options) {
            ...
            this.type = type;
             ...
             this.$element.parent('.image-loading').append('<span class="loading-progress" ><span class="inner" >');
        ...
        */
        ...
        fadeInImage: function() {
            ...
            this.images.each(function(idx, el){
                   ...
                   console.log('delay is: ' + self.options.delay);

                   // only fade in images below limit
                   //if(!self.options.showlimit || idx < self.options.showlimit) {
                    $(this).delay(self.options.delay).animate({opacity:1}, self.options.speed, function() {
                         if(idx === 0) {
